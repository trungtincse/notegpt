const __vite__mapDeps=(i,m=__vite__mapDeps,d=(m.f||(m.f=["./sizeCapture-X5ZJPWSS-m4P7fuEP.js","./index-BasOqtc3.js","./index-BiRXvjOt.js","./index-C1zpM4Oj.css"])))=>i.map(i=>d[i]);
import { _ as __vitePreload } from "./index-BiRXvjOt.js";
import { c as clear$2 } from "./chunk-RYQCIY6F-DTzSk-oc.js";
import { am as markers_default, an as clear2, ao as clear, ap as clear$1, l as log, c as getConfig2, ag as insertNode, af as insertCluster, ah as positionNode, at as insertEdge, av as insertEdgeLabel, z as getConfig, as as getSubGraphTitleMargins, aw as edgeLabels, y as utils_default, ax as terminalLabels, _ as __name, ay as markerOffsets } from "./index-BasOqtc3.js";
...
async function createGraphWithElements(element, data4Layout) {
  ...
  if (globalThis.mermaidCaptureSizes) {
    const { captureNodeSizes } = await __vitePreload(async () => {
      const { captureNodeSizes: captureNodeSizes2 } = await import("./sizeCapture-X5ZJPWSS-m4P7fuEP.js");

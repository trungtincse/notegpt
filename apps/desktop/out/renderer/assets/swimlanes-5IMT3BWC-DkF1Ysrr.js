const __vite__mapDeps=(i,m=__vite__mapDeps,d=(m.f||(m.f=["./sizeCapture-X5ZJPWSS-DMg8wb9s.js","./index-Dyjb4HE7.js","./index-COPilJin.js","./index-DbA3rRuE.css"])))=>i.map(i=>d[i]);
import { _ as __vitePreload } from "./index-COPilJin.js";
import { c as clear$2 } from "./chunk-RYQCIY6F-5l46hUu0.js";
import { am as markers_default, an as clear2, ao as clear, ap as clear$1, l as log, c as getConfig2, ag as insertNode, af as insertCluster, ah as positionNode, at as insertEdge, av as insertEdgeLabel, z as getConfig, as as getSubGraphTitleMargins, aw as edgeLabels, y as utils_default, ax as terminalLabels, _ as __name, ay as markerOffsets } from "./index-Dyjb4HE7.js";
...
async function createGraphWithElements(element, data4Layout) {
  ...
  if (globalThis.mermaidCaptureSizes) {
    const { captureNodeSizes } = await __vitePreload(async () => {
      const { captureNodeSizes: captureNodeSizes2 } = await import("./sizeCapture-X5ZJPWSS-DMg8wb9s.js");
